...
/* oxlint-disable jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions -- Pointer convenience mirrors the keyboard-accessible adjacent input; this is not a separate control. */
function InputGroupAddon({
  ...
  return (
    // Addon clicks only mirror focusing the adjacent keyboard-accessible input;
    // this container is not an additional interactive control.
    <div
